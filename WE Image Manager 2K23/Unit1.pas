...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure ImagemtmpClick(Sender: TObject);
  private
...
begin
  ...
  begin
    ...
    begin
      ...
      If (aGraf[b] = '0A') and (aGraf[b + 1] = '00') and (aGraf[b + 10] = '00')
        and (aGraf[b + 11] = '00') and (aGraf[b + 15] = '80') and
        ((aGraf[b + 14] = '10') or (aGraf[b + 14] = '11') or
        (aGraf[b + 14] = '12') or (aGraf[b + 14] = '0C') or
        (aGraf[b + 14] = '0D') or (aGraf[b + 14] = '0E') or
        (aGraf[b + 14] = '0F') or (aGraf[b + 14] = '08')) then
      begin
        offset := 0;
        If aGraf[b + 14] = '08' Then
          offset := strtoint('$' + aGraf[b + 13] + aGraf[b + 12]) + 5320;
        If aGraf[b + 14] = '0C' Then
          offset := strtoint('$' + aGraf[b + 13] + aGraf[b + 12]) - 32768;
        If aGraf[b + 14] = '0D' Then
          offset := strtoint('$' + aGraf[b + 13] + aGraf[b + 12]) + 32768;
        If aGraf[b + 14] = '0E' Then
          offset := strtoint('$' + aGraf[b + 13] + aGraf[b + 12]) + 98304;
        If aGraf[b + 14] = '0F' Then
          offset := strtoint('$' + aGraf[b + 13] + aGraf[b + 12]);
        If aGraf[b + 14] = '10' Then
          offset := strtoint('$' + '1' + aGraf[b + 13] + aGraf[b + 12]);
        If aGraf[b + 14] = '11' Then
          offset := strtoint('$' + '2' + aGraf[b + 13] + aGraf[b + 12]);
        If aGraf[b + 14] = '12' Then
          offset := strtoint('$' + '3' + aGraf[b + 13] + aGraf[b + 12]);

        Tab_graf.cells[0, Tab_graf.RowCount - 1] :=
          inttostr(Tab_graf.RowCount - 1);
        Tab_graf.cells[1, Tab_graf.RowCount - 1] := inttostr(offset);
        Tab_graf.cells[2, Tab_graf.RowCount - 1] := inttohex(offset, 4);
        Tab_graf.cells[3, Tab_graf.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf[b + 3] + aGraf[b + 2]));
        Tab_graf.cells[4, Tab_graf.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf[b + 5] + aGraf[b + 4]));
        Tab_graf.cells[5, Tab_graf.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf[b + 7] + aGraf[b + 6]) * 2);
        Tab_graf.cells[6, Tab_graf.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf[b + 9] + aGraf[b + 8]));
...
begin
  ...
  begin
    ...
    for b := 0 to x - 16 do
    begin
      if ((aGraf2[b] = '09') and (aGraf2[b + 10] = '00') and
        (aGraf2[b + 11] = '00') and (aGraf2[b + 15] = '80') and
        ((aGraf2[b + 14] = '10') or (aGraf2[b + 14] = '11') or
        (aGraf2[b + 14] = '12') or (aGraf2[b + 14] = '0C') or
        (aGraf2[b + 14] = '0D') or (aGraf2[b + 14] = '0E') or
        (aGraf2[b + 14] = '0F') or (aGraf2[b + 14] = '08'))) then

      begin
        offset := 0;

        If aGraf2[b + 14] = '08' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]) + 5352;
        If aGraf2[b + 14] = '0C' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]) - 32768;
        If aGraf2[b + 14] = '0D' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]) + 32768;
        If aGraf2[b + 14] = '0E' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]) + 98304;
        If aGraf2[b + 14] = '0F' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]);
        If aGraf2[b + 14] = '10' Then
          offset := strtoint('$' + '1' + aGraf2[b + 13] + aGraf2[b + 12]);
        If aGraf2[b + 14] = '11' Then
          offset := strtoint('$' + '2' + aGraf2[b + 13] + aGraf2[b + 12]);
        If aGraf2[b + 14] = '12' Then
          offset := strtoint('$' + '3' + aGraf2[b + 13] + aGraf2[b + 12]);

        Tab_pal.cells[0, Tab_pal.RowCount - 1] :=
          inttostr(Tab_pal.RowCount - 1);
        Tab_pal.cells[1, Tab_pal.RowCount - 1] := inttostr(offset);
        Tab_pal.cells[2, Tab_pal.RowCount - 1] := inttohex(offset, 4);
        Tab_pal.cells[3, Tab_pal.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf2[b + 3] + aGraf2[b + 2]));
        Tab_pal.cells[4, Tab_pal.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf2[b + 5] + aGraf2[b + 4]));
        Tab_pal.cells[5, Tab_pal.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf2[b + 7] + aGraf2[b + 6]) * 2);
        Tab_pal.cells[6, Tab_pal.RowCount - 1] :=
          inttostr(strtoint('$' + aGraf2[b + 9] + aGraf2[b + 8]));
      ...
      begin
        If aGraf2[b + 14] = '08' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]) + 5320;
        If aGraf2[b + 14] = '0C' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]) - 32768;
        If aGraf2[b + 14] = '0D' Then
          offset := strtoint('$' + aGraf2[b + 13] + aGraf2[b + 12]) + 32768;
    ...
    for b := 0 to Tab_pal.RowCount - 3 do
    begin
      for c := 0 to lista2.count - 1 do
      begin
        if strtoint(lista2.items.strings[c]) = strtoint(Tab_pal.cells[1, b + 1])
        then
          npos := c;
      end;

      valor := strtoint(Tab_pal.cells[1, b + 2]);
      tempor := strtoint(lista2.items.strings[npos + 1]) -
        strtoint(lista2.items.strings[npos]);
      Tab_pal.cells[7, b + 1] :=
        inttostr(strtoint(lista2.items.strings[npos + 1]) -
        strtoint(lista2.items.strings[npos]));
      Tab_pal.cells[8, b + 1] :=
        inttostr(strtoint(Tab_pal.cells[7, b + 1]) div 2);
      ...
      if ((aGraf2[valor - 32] = '0A') and (aGraf2[valor - 31] = '00') and
        ...
        (aGraf2[valor - 18] = '08'))) or
        ((aGraf2[valor - 32] = '09') and (aGraf2[valor - 23] = '00') and
        (aGraf2[valor - 22] = '00') and (aGraf2[valor - 17] = '80') and
        ((aGraf2[valor - 18] = '10') or (aGraf2[valor - 18] = '11') or
        (aGraf2[valor - 18] = '12') or (aGraf2[valor - 18] = '0C') or
        (aGraf2[valor - 18] = '0D') or (aGraf2[valor - 18] = '0E') or
        (aGraf2[valor - 18] = '0F') or (aGraf2[valor - 18] = '08'))) then

        tempor := strtoint(lista2.items.strings[npos + 1]) -
          strtoint(lista2.items.strings[npos]) - 32;
      Tab_pal.cells[7, b + 1] := inttostr(tempor);
      Tab_pal.cells[8, b + 1] := inttostr(tempor div 2);

    end;

    busca := strtoint(Tab_pal.cells[1, Tab_pal.RowCount]);

    repeat
      busca := busca + 1;
    until ((aGraf2[busca] = '0A') and (aGraf2[busca + 1] = '00') and
      ...
      (aGraf2[busca + 14] = '08'))) or
      ((aGraf2[busca] = '09') and (aGraf2[busca + 10] = '00') and
      (aGraf2[busca + 11] = '00') and (aGraf2[busca + 15] = '80') and
      ((aGraf2[busca + 14] = '10') or (aGraf2[busca + 14] = '11') or
      (aGraf2[busca + 14] = '12') or (aGraf2[busca + 14] = '0C') or
      (aGraf2[busca + 14] = '0D') or (aGraf2[busca + 14] = '0E') or
      (aGraf2[busca + 14] = '0F') or (aGraf2[busca + 14] = '08')));
...
var
  k, pos, col, lin, mat, alt, larg, offpal, xx, xx2: integer;
  cor: string;
  mult: byte;
  nvezes: integer;
...
begin
  ...
  if (cores = 16) then
    mult := 2;
  Label2.Caption := 'Grafico ' + Tab_graf.cells[0, Tab_graf.Row] + '  Palheta '
    + Tab_pal.cells[0, Tab_pal.Row] + chr(13) + chr(13) + inttostr(larg * mult)
    + ' X ' + inttostr(alt) + chr(13) + inttostr(cores) + ' Cores';
  ...
  while (xx < (((modif - 1999) * mult) + 1)) do
  begin
    if cores = 16 then
    begin
      if (xx mod 2) = 1 then
      begin
        if length(aNovo[1999 + xx2]) = 1 then
          aNovo[1999 + xx2] := '0' + aNovo[1999 + xx2];
...
begin
  ...
  begin
    ...
    Writeln(ArquivoTexto,
      '------------------------------------------------------------------------------------------------------------------------------');
    Writeln(ArquivoTexto,
      'ID     Offset Dec.     Offset Hexa      VRAM X         VRAM Y        Largura        Altura        Tamanho');
    Writeln(ArquivoTexto,
      '------------------------------------------------------------------------------------------------------------------------------');
    Writeln(ArquivoTexto, ' ');
    ...
    Writeln(ArquivoTexto,
      '------------------------------------------------------------------------------------------------------------------------------');
    Writeln(ArquivoTexto,
      'ID     Offset Dec.    Offset Hexa      VRAM X          VRAM Y         Largura        Altura        Tamanho        Cores');
    Writeln(ArquivoTexto,
      '------------------------------------------------------------------------------------------------------------------------------');
    Writeln(ArquivoTexto, ' ');
    ...
    Writeln(ArquivoTexto, ' ');
    Writeln(ArquivoTexto,
      'Obs: Se a palheta for de 4 bits, multiplicar a largura do grafico por 2');
...
var
  col, lin, alt, larg, offpal: integer;
  abc: TRect;
  arqtim: boolean;
...
begin
  if (RadioButton4.checked) and (Offsetgraf.Text <> '') and (largman.Text <> '')
    and (altman.Text <> '') and (Offsetpal.Text <> '') and
    (Coresman.ItemIndex <> -1) then
    visualiza(1);
...
begin
  ...
  begin
    ...
    lab.Brush.color := torgb(aGraf2[strtoint(Offsetpal.Text) + ((nvez * 2) + 1)]
      + aGraf2[strtoint(Offsetpal.Text) + (nvez * 2)], 0);
...
begin
  if (RadioButton2.checked) and (Offsetgraf.Text <> '') and (largman.Text <> '')
    and (altman.Text <> '') and (Offsetpal.Text <> '') and
    (Coresman.ItemIndex <> -1) then
    visualiza(1);
...
procedure TForm1.ImagemtmpClick(Sender: TObject);
begin
...
begin
  ...
  If ScrollBar2.Position = 1 Then
    CorGreen := 8;
  If ScrollBar3.Position = 1 Then
    CorBlue := 8;

  If ScrollBar1.Position = 2 Then
    CorRed := 16;
  If ScrollBar2.Position = 2 Then
    CorGreen := 16;
  If ScrollBar3.Position = 2 Then
    CorBlue := 16;

  If ScrollBar1.Position = 3 Then
    CorRed := 24;
  If ScrollBar2.Position = 3 Then
    CorGreen := 24;
  If ScrollBar3.Position = 3 Then
    CorBlue := 24;

  If ScrollBar1.Position = 4 Then
    CorRed := 32;
  If ScrollBar2.Position = 4 Then
    CorGreen := 32;
  If ScrollBar3.Position = 4 Then
    CorBlue := 32;

  If ScrollBar1.Position = 5 Then
    CorRed := 41;
  If ScrollBar2.Position = 5 Then
    CorGreen := 41;
  If ScrollBar3.Position = 5 Then
    CorBlue := 41;

  If ScrollBar1.Position = 6 Then
    CorRed := 49;
  If ScrollBar2.Position = 6 Then
    CorGreen := 49;
  If ScrollBar3.Position = 6 Then
    CorBlue := 49;

  If ScrollBar1.Position = 7 Then
    CorRed := 57;
  If ScrollBar2.Position = 7 Then
    CorGreen := 57;
  If ScrollBar3.Position = 7 Then
    CorBlue := 57;

  If ScrollBar1.Position = 8 Then
    CorRed := 65;
  If ScrollBar2.Position = 8 Then
    CorGreen := 65;
  If ScrollBar3.Position = 8 Then
    CorBlue := 65;

  If ScrollBar1.Position = 9 Then
    CorRed := 74;
  If ScrollBar2.Position = 9 Then
    CorGreen := 74;
  If ScrollBar3.Position = 9 Then
    CorBlue := 74;

  If ScrollBar1.Position = 10 Then
    CorRed := 82;
  If ScrollBar2.Position = 10 Then
    CorGreen := 82;
  ...
  If ScrollBar1.Position = 11 Then
    CorRed := 90;
  If ScrollBar2.Position = 11 Then
    CorGreen := 90;
  If ScrollBar3.Position = 11 Then
    CorBlue := 90;

  If ScrollBar1.Position = 12 Then
    CorRed := 98;
  If ScrollBar2.Position = 12 Then
    CorGreen := 98;
  If ScrollBar3.Position = 12 Then
    CorBlue := 98;

  If ScrollBar1.Position = 13 Then
    CorRed := 106;
  If ScrollBar2.Position = 13 Then
    CorGreen := 106;
  If ScrollBar3.Position = 13 Then
    CorBlue := 106;

  If ScrollBar1.Position = 14 Then
    CorRed := 115;
  If ScrollBar2.Position = 14 Then
    CorGreen := 115;
  If ScrollBar3.Position = 14 Then
    CorBlue := 115;

  If ScrollBar1.Position = 15 Then
    CorRed := 123;
  If ScrollBar2.Position = 15 Then
    CorGreen := 123;
  If ScrollBar3.Position = 15 Then
    CorBlue := 123;

  If ScrollBar1.Position = 16 Then
    CorRed := 131;
  If ScrollBar2.Position = 16 Then
    CorGreen := 131;
  If ScrollBar3.Position = 16 Then
    CorBlue := 131;

  If ScrollBar1.Position = 17 Then
    CorRed := 139;
  If ScrollBar2.Position = 17 Then
    CorGreen := 139;
  If ScrollBar3.Position = 17 Then
    CorBlue := 139;

  If ScrollBar1.Position = 18 Then
    CorRed := 148;
  If ScrollBar2.Position = 18 Then
    CorGreen := 148;
  If ScrollBar3.Position = 18 Then
    CorBlue := 148;

  If ScrollBar1.Position = 19 Then
    CorRed := 156;
  If ScrollBar2.Position = 19 Then
    CorGreen := 156;
  If ScrollBar3.Position = 19 Then
    CorBlue := 156;
  ...
  If ScrollBar2.Position = 20 Then
    CorGreen := 164;
  If ScrollBar3.Position = 20 Then
    CorBlue := 164;

  If ScrollBar1.Position = 21 Then
    CorRed := 172;
  If ScrollBar2.Position = 21 Then
    CorGreen := 172;
  If ScrollBar3.Position = 21 Then
    CorBlue := 172;

  If ScrollBar1.Position = 22 Then
    CorRed := 180;
  If ScrollBar2.Position = 22 Then
    CorGreen := 180;
  If ScrollBar3.Position = 22 Then
    CorBlue := 180;

  If ScrollBar1.Position = 23 Then
    CorRed := 189;
  If ScrollBar2.Position = 23 Then
    CorGreen := 189;
  If ScrollBar3.Position = 23 Then
    CorBlue := 189;

  If ScrollBar1.Position = 24 Then
    CorRed := 197;
  If ScrollBar2.Position = 24 Then
    CorGreen := 197;
  If ScrollBar3.Position = 24 Then
    CorBlue := 197;

  If ScrollBar1.Position = 25 Then
    CorRed := 205;
  If ScrollBar2.Position = 25 Then
    CorGreen := 205;
  If ScrollBar3.Position = 25 Then
    CorBlue := 205;

  If ScrollBar1.Position = 26 Then
    CorRed := 213;
  If ScrollBar2.Position = 26 Then
    CorGreen := 213;
  If ScrollBar3.Position = 26 Then
    CorBlue := 213;

  If ScrollBar1.Position = 27 Then
    CorRed := 222;
  If ScrollBar2.Position = 27 Then
    CorGreen := 222;
  If ScrollBar3.Position = 27 Then
    CorBlue := 222;

  If ScrollBar1.Position = 28 Then
    CorRed := 230;
  If ScrollBar2.Position = 28 Then
    CorGreen := 230;
  If ScrollBar3.Position = 28 Then
    CorBlue := 230;

  If ScrollBar1.Position = 29 Then
    CorRed := 238;
  If ScrollBar2.Position = 29 Then
    CorGreen := 238;
  If ScrollBar3.Position = 29 Then
    CorBlue := 238;

  If ScrollBar1.Position = 30 Then
    CorRed := 246;
  If ScrollBar2.Position = 30 Then
    CorGreen := 246;
  If ScrollBar3.Position = 30 Then
    CorBlue := 246;

  If ScrollBar1.Position = 31 Then
    CorRed := 255;
  If ScrollBar2.Position = 31 Then
    CorGreen := 255;
  If ScrollBar3.Position = 31 Then
    CorBlue := 255;
end;
...
begin
  ...
  while cores > nvez do
  begin
    aGraf2[strtoint(Offsetpal.Text) + ((nvez * 2) + 1)] :=
      copy(aPalMod[nvez], 1, 2);
...
begin
  ...
  begin
    ...
    begin
      aPalMod[nvez] := aGraf2[strtoint(Offsetpal.Text) + ((nvez * 2) + 1)] +
        aGraf2[strtoint(Offsetpal.Text) + (nvez * 2)];
